...
public class PersonItem extends AggregateItem {

	private static Logger logger = LogManager.getLogger( PersonItem.class.getName());
	
	private TmsUser user;

	public PersonItem( AggregateItem parent, TmsUser user ) {
