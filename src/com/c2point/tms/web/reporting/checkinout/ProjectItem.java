...
public class ProjectItem extends AggregateItem {

	private static Logger logger = LogManager.getLogger( ProjectItem.class.getName());
	
	private Project project;
	
	public ProjectItem( AggregateItem parent, Project project ) {
	...
	protected AggregateItem createChild( TmsUser user, CheckInOutRecord record) {
		...
		return new PersonItem( this, user );
