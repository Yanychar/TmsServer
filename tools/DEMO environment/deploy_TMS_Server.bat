...
set dest_srv=ubuntu@demo.uisko.com
...
"C:\Program Files\PuTTY"\plink -ssh -i %dest_key% %dest_srv% sudo mv %dest_dir_archive%/%app_name%.8 %dest_dir_archive%/%app_name%.9
"C:\Program Files\PuTTY"\plink -ssh -i %dest_key% %dest_srv% sudo mv %dest_dir_archive%/%app_name%.7 %dest_dir_archive%/%app_name%.8
"C:\Program Files\PuTTY"\plink -ssh -i %dest_key% %dest_srv% sudo mv %dest_dir_archive%/%app_name%.6 %dest_dir_archive%/%app_name%.7
"C:\Program Files\PuTTY"\plink -ssh -i %dest_key% %dest_srv% sudo mv %dest_dir_archive%/%app_name%.5 %dest_dir_archive%/%app_name%.6
